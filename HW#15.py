...
# В одній годині 60 * 60 сек, в одній добі 24 * 60 * 60 сек.
...
#8647263
import string
digit = int(input('Enter seconds:'))
d = 86400
h = 3600
m = 60
day, digit = divmod(digit, d)
hour, digit = divmod(digit, h)
minutes, digit = divmod(digit, m)
hour = str(hour).zfill(2)
minutes = str(minutes).zfill(2)
seconds = str(digit).zfill(2)
print(day, 'day', hour, ':', minutes, ':', seconds)
